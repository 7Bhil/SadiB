      ...
      <section class="hero">
        ...
        <div class="container hero-content">
          <div class="reveal">
            ...
            <div class="hero-btns">
              <router-link to="/collections" class="btn btn-gold">Découvrir la Collection</router-link>
              <router-link to="/histoire" class="btn btn-outline">Notre Histoire</router-link>
            </div>
          </div>
        </div>
