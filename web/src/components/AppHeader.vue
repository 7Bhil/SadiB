  ...
  <header :class="{ 'header-glass': isScrolled }">
    <div class="container header-container">
      ...
      <nav :class="{ 'nav-open': mobileOpen }">
        <ul class="nav-links">
          <li><router-link to="/boutique" class="nav-link">Boutique</router-link></li>
          <li><router-link to="/collections" class="nav-link">Collection</router-link></li>
          <li><router-link to="/histoire" class="nav-link">Histoire</router-link></li>
